  ...
  const educations = [
    {
    ...
    },
      {
          ...
          description: "Данных подход к организации образовательной программы позволяет выпускникам работать в области разработки и поддержки сайтов, мобильных приложений, интеграции с CRM, web-аналитики, компьютерной графики и анимации, а также в других областях дизайна и медиа производства. Студенты получают глубокую теоретическую подготовку в области программирования, IT-технологий, цифрового дизайна."
      },
  ]
