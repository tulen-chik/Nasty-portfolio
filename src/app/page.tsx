  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      },
      {
          ...
          images: ["/для авы копия.jpg", "/визитки другой серый этот_Страница_1.jpg", "/визитки другой серый этот_Страница_1.jpg", ],
      ...
      },
      {
          ...
          images: ["/на печать стена.jpg", "/на печать рельсы.jpg", "/на печать освобождение_page-0001.jpg", ],
